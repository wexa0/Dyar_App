...
struct HabitsView: View {
    ...
    private var mainContentSection: some View {
        VStack(spacing: 19) {
            ...
            VStack(spacing: 19) {
                infoCard(
                    title: "القراءة النجدية",
                    description: "هي أسلوب خاص في تلاوة القرآن الكريم يشتهر به أهل نجد.",
                    imageName: "read",
                ...
                infoCard(
                    title: "الشعر والأدب",
                    description: "شهدت أرض نجد قصص الحب التي خلدها الأدب العربي الإسلامي قديماً.",
                    imageName: "adb",
                    titleStrokeColor: Color(hex: "FCE3CB")
                )
            }
    ...
    // MARK: - Descriptive Box (SAME AS BuildingView)
    private var descriptiveBox: some View {
        ZStack(alignment: .leading) {
            HStack(spacing: 0) {
                Text("لبس المشالح للرجال كان ضرورة ومن النادر أن تجد رجل بدون بشت.")
    ...
    // MARK: - Card (SAME AS BuildingView)
