...
struct FoodView: View {
    ...
    private var mainContentSection: some View {
        VStack(spacing: 19) {
            ...
            VStack(spacing: 19) {
                foodCard(
                    title: "القرصان",
                    description: "أكلة نجدية تقليدية تُصنع من خبز رقيق يُقرّص ويفرد على الصاج، ثم يُقطع ويُغمر في مرق لذيذ مع الخضار.",
                    imageName: "qursan"
                )
                
                foodCard(
                    title: "الجريش",
                    description: "الجريش هو قمح مجروش يُطهى ببطء مع اللبن والبهارات حتى يصير قوامه ثقيل ودسم.",
                    imageName: "jaresh"
                )
            }
            .padding(.bottom, 36)
    ...
    private var descriptiveBox: some View {
        ZStack(alignment: .leading) {
            HStack(spacing: 0) {
                Text("كان يحفظ اللحم عن طريق تشريحه وتمليحه ونشره بالشمس ليجف تماما ويسمى ( القفر ).")
