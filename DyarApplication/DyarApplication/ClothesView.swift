...
struct ClothesView: View {
    ...
    private var mainContentSection: some View {
        VStack(spacing: 19) {
            ...
            VStack(spacing: 19) {
                clothesCard(
                    title: "ثوب المرودن",
                    description: "ثوب رجالي نجدي بأكمام طويلة و واسعة يُلبس في المناسبات .",
                    imageName: "MEN",
                ...
                clothesCard(
                    title: "ثوب النشل",
                    description: "ثوب نسائي نجدي فخم مطرز بالذهبي يُلبس في الأعراس .",
                    imageName: "WOMAN",
                    titleStrokeColor: Color(hex: "FCE3CB")
                )
            }
    ...
    private var descriptiveBox: some View {
        ZStack(alignment: .leading) {
            HStack(spacing: 0) {
                Text("ملابس اهل نجد تعكس الاصالة والتاريخ وتتميز بقطع فضفاضه ومطزرة.")
