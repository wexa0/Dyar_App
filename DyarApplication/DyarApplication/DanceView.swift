...
struct DanceView: View {
    ...
    private var mainContentSection: some View {
        VStack(spacing: 19) {
            ...
            VStack(spacing: 19) {
                cardView(
                    title: "العرضة النجدية",
                    description: "هي رقصة شعبية تؤدى في المناسبات الوطنية والمهرجانات.",
                    imageName: "njd"
                )
                
                cardView(
                    title: "فن السامري",
                    description: "هو فن غنائي تؤديه مجموعتان متقابلتان، وتقوم إحدى المجموعات بضرب الطيران “الدف” على لحن يحدده الشاعر.",
                    imageName: "fnn"
                )
            }
            .padding(.bottom, 36)
    ...
    private var descriptiveBox: some View {
        ZStack(alignment: .leading) {
            HStack(spacing: 0) {
                Text("تسمى العرضة النجدية بـ(رقصة السيف) تجسيد للروح الوطنية والتراث الحربي.")
